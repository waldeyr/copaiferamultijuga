...
<body>
    <div class="container clearfix">
        <header class="header">
            ...
            <nav class="menu">
                <ul>
                    <li><a href="restrictarea.php">Home</a></li>
                    <li><a href="pathways.php">Metabolic Pathways</a></li>
                    <li><a href="swissprot.php">Swiss Prot</a></li>
                    <li><a href="trembl.php">TrEMBL</a></li>
                    <li><a href="brenda.php">BRENDA</a></li>
                    <li><a href="mannual.php">Mannual</a></li>
